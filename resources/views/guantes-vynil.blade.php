        ...
        <div class="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div class="flex flex-col justify-center reveal reveal-fade-in" style="transition-delay: 200ms;">
                ...
                <p class="text-gray-600 leading-relaxed mb-8 text-lg">
                    Son ideales para quienes necesitan una barrera protectora confiable y libre de alérgenos comunes
                    asociados con el látex y el polvo. Su menor espesor es ideal para actividades que requieran mayor
    ...
    <section class="py-12 bg-[#fbfbfd] border-t border-gray-100">
        <div class="max-w-[800px] mx-auto px-6">
            ...
            <div class="mb-4">
                ...
                <div class="accordion-content">
                    <div class="p-6 text-gray-600 leading-relaxed">
                        <p class="mb-2"><strong>Junior:</strong> Caja c/ 100 guantes.</p>
                        <p><strong>Master:</strong> Corrugado c/ 20 cajas.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="accordion-content">
                    <div class="p-6 text-gray-600 leading-relaxed">
                        <p>Cumple con las Normas Oficiales Mexicanas y estándares internacionales de calidad.</p>
                    </div>
                </div>
            </div>
