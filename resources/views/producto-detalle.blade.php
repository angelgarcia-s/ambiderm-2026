...
<head>
    ...
    <title>Guantes Colorfull - Ambiderm</title>
    <!-- Tailwind CSS CDN -->
...
<body class="font-sans text-[#1d1d1f] bg-white selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden">
    ...
    <div class="pt-24 pb-4 px-6 md:px-12 bg-white">
        <div class="max-w-[1240px] mx-auto flex items-center text-xs text-gray-400 uppercase tracking-widest gap-2">
            ...
            <span class="text-gray-300">/</span>
            <span class="text-blue-600 font-bold">Guantes Colorfull</span>
        </div>
    </div>
    ...
    <section class="pb-24 px-6 md:px-12 bg-white">
        <div class="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div class="relative sticky-col">
                ...
                <!-- Thumbnails (Simplified for this version) -->
                <!-- <div class="flex gap-4 mt-6 justify-center">
                    <button class="w-16 h-16 rounded-xl border border-blue-600 p-2"><img src="..." class="mix-blend-multiply"></button>
                    <button class="w-16 h-16 rounded-xl border border-gray-100 p-2 opacity-50"><img src="..." class="mix-blend-multiply"></button>
                </div> -->
            </div>
            ...
            <div class="flex flex-col justify-center reveal reveal-fade-in" style="transition-delay: 200ms;">
                <div class="mb-2">
                    <span
                        class="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-widest border border-blue-100">Más
                        Vendido</span>
                    <span
                        class="inline-block px-3 py-1 rounded-full bg-purple-50 text-purple-600 text-[10px] font-bold uppercase tracking-widest border border-purple-100 ml-2">Colores
                        Divertidos</span>
                </div>

                <h1 class="text-4xl md:text-5xl font-black text-[#1d1d1f] mb-2 tracking-tight">Colorfull</h1>
                ...
                <div class="space-y-8 mb-10 border-t border-b border-gray-100 py-8">
                    ...
                    <div>
                        <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Color Seleccionado:
                            <span id="color-name" class="text-[#1d1d1f]">Surtido</span>
                        </p>
                        <div class="flex gap-4">
                            <button
                                class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 ring-2 ring-offset-2 ring-blue-600 color-option  active"
                                data-color="Surtido"
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            <button
                                class="size-option w-12 h-12 rounded-xl border border-gray-200 text-gray-500 font-bold hover:bg-gray-50 flex items-center justify-center">XS</button>
                            <button
                ...
                <ul class="space-y-3 mb-10">
                    ...
                    <li class="flex items-center text-gray-600 font-medium">
                        <i data-lucide="check-circle-2" class="w-5 h-5 text-blue-600 mr-3"></i> Ambidiestro y liso
                    </li>
                    <li class="flex items-center text-gray-600 font-medium">
                        <i data-lucide="check-circle-2" class="w-5 h-5 text-blue-600 mr-3"></i> Bajo contenido de polvo
                    </li>
                    <li class="flex items-center text-gray-600 font-medium">
                        <i data-lucide="check-circle-2" class="w-5 h-5 text-blue-600 mr-3"></i> Cumple Normas Oficiales
                    </li>
                </ul>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <a href="https://ambiderm.com.mx/productos/guantes/esteril"
                    ...
                    <div class="text-center">
                        <h4 class="font-bold text-lg text-[#1d1d1f]">Estéril</h4>
                ...
                <a href="https://ambiderm.com.mx/productos/guantes/kid-gloves"
                    ...
                    <div class="text-center">
                        <h4 class="font-bold text-lg text-[#1d1d1f]">Kid Gloves</h4>
    ...
    <footer class="bg-white pt-10 overflow-hidden" id="contacto">
        <!-- (Reusing the same consistent footer code for simplicity, compacted here but ensuring structure matches) -->
        <!-- Content identical to {{ route('productos') }} footer but starting from the logo/social section for consistency -->
    ...
    <script>
        ...
        colorBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                // Optional: Change image if data-img attribute is present
                // if(btn.getAttribute('data-img')) mainImage.src = btn.getAttribute('data-img');
            });
        });
