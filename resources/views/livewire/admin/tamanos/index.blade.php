    ...
    <flux:modal wire:model="showImportModal" class="max-w-lg w-full" :dismissible="false">
        <form wire:submit="procesarImportacion" class="space-y-6">
            <div>
                ...
                <flux:subheading>Se crearán registros nuevos y se <strong>actualizarán los existentes</strong> (mismo nombre). Columnas requeridas: <code>nombre, abreviatura, orden</code>.</flux:subheading>
            </div>
