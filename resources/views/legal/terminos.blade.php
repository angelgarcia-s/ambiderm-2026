<x-layouts.public title="Términos y Condiciones - Ambiderm">
    ...
    <section class="py-20 px-6">
        <div class="max-w-[800px] mx-auto">
            ...
            <div class="space-y-5 text-gray-600 leading-relaxed">
                ...
                <p>Este contrato describe los términos y condiciones generales (en adelante "TÉRMINOS Y CONDICIONES") aplicables al uso de los contenidos, productos y servicios ofrecidos a través del sitio web www.ambiderm.com.mx (en adelante, "SITIO WEB"), del cual es titular Ambiderm, S.A. de C.V. (en adelante e indistintamente, “Ambiderm®” o el “TITULAR”), con domicilio en Avenida Carretera a Bosques de San Isidro 1136, Colonia San Isidro, Zapopan, Jalisco, C.P. 45147.</p>
                ...
                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">I. DEL OBJETO.</h4>
                <p>El objeto de los presentes TÉRMINOS Y CONDICIONES es regular el acceso y la utilización del SITIO WEB, entendiendo por este cualquier tipo de contenido, producto o servicio que se encuentre a disposición del público en general dentro del dominio www.ambiderm.com.mx.</p>

                <p>El TITULAR se reserva la facultad de modificar en cualquier momento y sin previo aviso, la presentación, los contenidos, la funcionalidad, los productos, los servicios, y la configuración que pudiera estar contenida en el SITIO WEB; en este sentido, el USUARIO reconoce y acepta que Ambiderm® en cualquier momento podrá interrumpir, desactivar o cancelar cualquiera de los elementos que conforman el SITIO WEB o el acceso a los mismos.</p>
                ...
                <p>El acceso a parte de los contenidos y servicios del SITIO WEB podrá realizarse previa suscripción o registro previo del USUARIO. El SITIO WEB se encuentra dirigido exclusivamente a personas que cuenten con la mayoría de edad (mayores de 18 años); en este sentido, Ambiderm® declina cualquier responsabilidad por el incumplimiento de este requisito.</p>

                <p>El SITIO WEB está dirigido principalmente a USUARIOS residentes en la República Mexicana, por lo cual, Ambiderm® no asegura que el SITIO WEB cumpla total o parcialmente con la legislación de otros países, de forma que, si el USUARIO reside o tiene su domicilio establecido en otro país y decide acceder o utilizar el SITIO WEB lo hará bajo su propia responsabilidad y deberá asegurarse de que tal acceso y navegación cumple con la legislación local que le es aplicable, no asumiendo el TITULAR ninguna responsabilidad que se pueda derivar de dicho acto.</p>
                ...
                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">II. Del Usuario.</h4>
                ...
                <p>Ambiderm® se reserva el derecho de retirar todos aquellos comentarios y aportaciones que vulneren la ley, el respeto a la dignidad de la persona, que sean discriminatorios, atenten contra los derechos de tercero o el orden público, o bien, que a su juicio no resulten adecuados para su publicación.</p>

                <p>En cualquier caso, Ambiderm® no será responsable de las opiniones vertidas por los USUARIOS a través de comentarios o publicaciones que estos realicen.</p>
                ...
                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">III. Del Acceso y Navegación en el Sitio Web.</h4>
                <p>El TITULAR no garantiza de ningún modo la continuidad y disponibilidad de los contenidos, productos o servicios ofrecidos a través del SITIO WEB; no obstante, el TITULAR llevará a cabo las acciones que de acuerdo a sus posibilidades le permitan mantener el buen funcionamiento del SITIO WEB, sin que esto suponga alguna responsabilidad de parte de Ambiderm®</p>

                <p>De igual forma, el TITULAR no será responsable ni garantiza que el contenido o software al que pueda accederse a través del SITIO WEB, se encuentre libre de errores, software malicioso, o que pueda causar algún daño a nivel de software o hardware en el equipo a través del cual el USUARIO accede al SITIO WEB.</p>

                <p>El TITULAR tampoco se hace responsable de los daños que pudiesen ocasionarse por un uso inadecuado del SITIO WEB. En ningún caso el TITULAR será responsable por las pérdidas, daños o perjuicios de cualquier tipo que surjan por el sólo acceso o utilización del SITIO WEB.</p>

                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">IV. Política de Privacidad y Protección de Datos.</h4>
                ...
                <p>Además, a efecto de dar cumplimiento a lo establecido en la Ley mencionada en el párrafo que antecede, todo dato personal que sea recabado a través del SITIO WEB, será tratado de conformidad con los principios de licitud, calidad, finalidad, lealtad, y responsabilidad. Todo tratamiento de datos personales quedará sujeto al consentimiento de su titular. En cualquier caso, la utilización de datos financieros o patrimoniales, requerirán de autorización expresa de sus titulares. No obstante, esta podrá darse a través del propio SITIO WEB utilizando los mecanismos habilitados para tal efecto, y en todo caso se dará la mayor diligencia y cuidado a este tipo de datos. Lo mismo ocurrirá en el caso de datos personales sensibles, considerando por estos aquellos que debido a una utilización indebida puedan dar origen a discriminación o su divulgación conlleve un riesgo para el titular.</p>
                ...
                <p>El tratamiento de datos personales se limitará al cumplimiento de las finalidades previstas en el Aviso de Privacidad, el cual se encuentra disponible en el sitio web www.ambiderm.com.mx, en la sección “Aviso de privacidad”.</p>
                <p>El SITIO WEB podrá incluir hipervínculos o enlaces que permitan acceder a páginas web de terceros distintos de el TITULAR. Los titulares de dichos sitios web dispondrán de sus propias políticas de privacidad y protección de datos, por lo cual Ambiderm® no asume ningún tipo de responsabilidad por los datos que san facilitados por el USUARIO a través de cualquier sitio web distinto a www.ambiderm.com.mx</p>
                <p>Ambiderm® se reserva el derecho a modificar su Política de Privacidad, de acuerdo a sus necesidades o derivado de algún cambio en la legislación. El acceso o utilización del SITIO WEB después de dichos cambios, implicará la aceptación de estos cambios.</p>
                ...
                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">V. POLÍTICA DE ENLACES.</h4>
                ...
                <p>La utilización de estos enlaces, contenidos, servicios o funciones, tiene por objeto mejorar la experiencia del USUARIO al hacer uso del SITIO WEB, sin que pueda considerarse una sugerencia, recomendación o invitación para hacer uso de sitios externos.</p>

                <p>Ambiderm® en ningún caso revisará o controlará el contenido de los sitios externos; de igual forma, no hace propios los productos, servicios, contenidos, y cualquier otro material existente en los referidos sitios enlazados; por lo cual, tampoco se garantizará la disponibilidad, exactitud, veracidad, validez o legalidad de los sitios externos a los que se pueda tener acceso a través del SITIO WEB. Así mismo, el TITULAR no asume ninguna responsabilidad por los daños y perjuicios que pudieran producirse por el acceso o uso, de los contenidos, productos o servicios disponibles en los sitios web no gestionados por Ambiderm® a los que se pueda acceder mediante el SITIO WEB.</p>

                <p>Los USUARIOS o terceros que realicen o publiquen un enlace web desde una página web externa, a este SITIO WEB deberán tomar en cuenta lo siguiente:</p>

                <p>No se permite la reproducción (total o parcial) de los contenidos, productos o servicios disponibles en el SITIO WEB sin la autorización expresa de Ambiderm® o su titular. Tampoco se permitirán manifestaciones falsas, inexactas o incorrectas sobre el SITIO WEB, ni sobre sus contenidos, productos o servicios, pudiendo el TITULAR restringir el acceso al SITIO WEB a toda aquella persona que incurra en este tipo de actos.</p>

                <p>El establecimiento de un enlace al SITIO WEB desde cualquier sitio externo, no implicará la existencia de alguna relación entre EL TITULAR y el titular del sitio web desde el cual se realice, tampoco implicará el conocimiento de Ambiderm® de los contenidos, productos o servicios ofrecidos en los sitios externos desde los cuales se pueda acceder al SITIO WEB.</p>

                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">VI. Política en Materia de Propiedad Intelectual.</h4>
                <p>El TITULAR por sí o como parte cesionaria, es titular de todos los derechos de propiedad intelectual del SITIO WEB, entendiendo por este el código fuente que hace posible su funcionamiento así como las imágenes, archivos de audio o video, logotipos, marcas, combinaciones de colores, estructuras, diseños y demás elementos que lo distinguen. Serán, por consiguiente, protegidas por la legislación mexicana en materia de propiedad intelectual e industrial, así como por los tratados internacionales aplicables. Por consiguiente, queda expresamente prohibida la reproducción, distribución, o difusión de los contenidos del SITIO WEB, con fines comerciales, en cualquier soporte y por cualquier medio, sin la autorización de Ambiderm®</p>

                <p>El USUARIO se compromete a respetar los derechos de propiedad intelectual del TITULAR. No obstante, además de poder visualizar los elementos del SITIO WEB podrá imprimirlos, copiarlos o almacenarlos, siempre y cuando sea para su uso estrictamente personal.</p>
                ...
                <p>En caso de que el USUARIO o algún tercero consideren que cualquiera de los contenidos del SITIO WEB suponga una violación de los derechos de protección de la propiedad intelectual, deberá comunicarlo inmediatamente a Ambiderm® a través de los datos de contacto disponibles en el propio SITIO WEB y/o a través de los siguientes medios: Teléfono: <a href="tel:3336566557" class="text-brand-blue hover:underline">33 3656-6557</a> — Correo electrónico: <a href="mailto:protecciondedatos@ambiderm.com.mx" class="text-brand-blue hover:underline">protecciondedatos@ambiderm.com.mx</a></p>

                <h4 class="text-sm font-bold text-brand-ink uppercase tracking-wider pt-6 border-t border-gray-100">VII. Legislación y Jurisdicción Aplicable.</h4>

                <p>Ambiderm® se reserva la facultad de presentar las acciones civiles o penales que considere necesarias por la utilización indebida del SITIO WEB, sus contenidos, productos o servicios, o por el incumplimiento de los presentes TÉRMINOS Y CONDICIONES.</p>

                <p>La relación entre el USUARIO y el TITULAR se regirá por la legislación vigente en México, específicamente en el Estado de Jalisco. De surgir cualquier controversia en relación a la interpretación y/o a la aplicación de los presentes TÉRMINOS Y CONDICIONES, las partes se someterán a la jurisdicción ordinaria de los tribunales competentes del Primer Partido Judicial de Jalisco, renunciando en consecuencia al fuero que por razón de sus domicilios presentes, futuros o por cualquier otro motivo, pudiere corresponderles.</p>
